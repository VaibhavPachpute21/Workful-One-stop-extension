  ...
  return (
    <div
      style={{
        ...
        width: '168px', height: 'max-content', padding: '10px',
        backgroundImage: 'linear-gradient(to bottom,#9DD5FF,#118AE3)',
        borderRadius: '10px', fontSize: '18px', color: 'white', fontFamily: 'monospace'
      }}>
      <form onSubmit={search}>
        <input
          style={{ backgroundColor: '#F7F8F9', border: '1px solid #DBE2E9 !important', borderRadius: '100px', padding: '5px', fontSize: '12px',fontFamily:'monospace' }}
      ...
      <div
        style={{ fontSize: '22px', fontWeight: '500', fontFamily: 'monospace' }}
      >{weather.weather}</div>
      <div
        style={{ fontSize: '16px', fontWeight: '400', textTransform: 'capitalize', fontFamily: 'monospace' }}
      >{weather.weatherDes}</div>

      <div
        style={{ fontSize: '14px', fontWeight: '400', textTransform: 'capitalize' }}
